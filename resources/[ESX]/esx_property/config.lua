...
Config.SaveInterval = 2 -- Interval in Minutes to Save Properties
...
Config.CanCustomiseInventoryAndWardrobePositions = false -- Allow users to customise inventory and wardrobe positions Default: true
  ...
  IPL = {
    ...
    },
    {
      ...
      positions = {
        ...
        Storage = vector3(265.9162, -999.45, -99.02), -- Only Works with Ox Inventory
      },
      type = "ipl",
    ...
    {
      label = "Appartement (Motel)",
      value = "appartement_motel",
      positions = {
        Wardrobe = vector3(1116.9374, -3162.8467, -36.8705),
        Storage = vector3(151.34512329102,-1003.0447387695,-99.0), -- Only Works with Ox Inventory
      },
      type = "ipl",
      pos = vector3(151.46,-1007.74,-99)
    },
  },
  Shells = {
    {
