...
AddEventHandler('esx_status:onTick', function(data)
	...
	for k, v in pairs(data) do
		...
		elseif v.name == 'hunger' and v.percent < 10.0000 and v.percent > 9.9850 then
			TriggerEvent('InteractSound_CL:PlayOnOne', 'stomach', 0.5)
		elseif v.name == 'thirst' and v.percent < 10.0000 and v.percent > 9.9800 then
			TriggerEvent('InteractSound_CL:PlayOnOne', 'throat', 0.5)
		end
	end
